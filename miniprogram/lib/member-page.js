...
module.exports=function(){return {
 data:{title:'请主动登录',detail:'公共浏览不需要会员绑定。',pairCode:'',pairLabel:'',expiryText:'',verifiedText:'',message:'',busy:false,authenticated:false,pending:false,deletionState:'',demo:!!(api.config.demo&&api.config.demo.enabled),testing:api.config.environment==='test'},
