...
从独立空白 Android 模板开发的本地笔记应用。当前任务为 `V2-EXPLICIT-RELATIONS-001`；文字核心、分类、回收站、提醒与备份已验收。离线语音已接入，识别质量验收尚未通过。
...
已保存笔记的编辑器可打开「相关笔记」，明确选择另一条真实笔记建立双向关系，或确认移除关系。每页最多50条，可搜索、翻页和按稳定ID打开；回收站中的端点暂时隐藏，恢复后原关系重新显示。当前备份不包含笔记关系。见[关系验证记录](doc/relations-verification.md)。
