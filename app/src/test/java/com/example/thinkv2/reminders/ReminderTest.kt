...
class ReminderTest {
    ...
    @Test fun schemaTwoUpgradePreservesNotesDraftsCategoriesAndRollsBackOnFailure() {
        ...
        for(table in listOf("reminders","reminder_events","reminder_runtime","backup_imports","backup_origins","calendar_imports","ai_acceptances","note_relations","correction_vocabulary")) sql.execute("DROP TABLE $table")
        ...
        assertEquals(listOf(listOf("8")),sql.query("PRAGMA user_version"));notes.close()
    }
